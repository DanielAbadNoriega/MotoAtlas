...
describe('importUtils', () => {
  it('genera payload final compatible con Supabase en snake_case', () => {
    ...
    expect(payload).toMatchObject({
      ...
      image_source: completeMotorcycle.imageSource,
      is_a2_compatible: completeMotorcycle.isA2Compatible,
      is_a2_limited_version: completeMotorcycle.isA2LimitedVersion,
      price_eur: completeMotorcycle.priceEur,
      price_source: completeMotorcycle.priceSource,
      reliability_score: completeMotorcycle.reliabilityReports.reliabilityScore,
      reliability_source: completeMotorcycle.reliabilitySource,
      report_count: completeMotorcycle.reliabilityReports.reportCount,
      specs_source: completeMotorcycle.specsSource,
